...
--
-- Host: localhost:3306
-- Generation Time: Oct 14, 2025 at 12:25 AM
...
(1, 1, 4, '2025-10-12 23:40:06', 'Oks Ra <3', NULL, NULL, 'For CBC Count', '2025-10-13 11:54:14', '2025-10-13 11:55:35', 'Medtech. Jardeesj');
...
(1, 'TST001', 7, 1, 'CBC', 'Blood', '2025-10-30', NULL, 'ordered', '2025-10-12 15:40:06', '2025-10-13 11:54:14');
...
(1, 'appointment_reminder_email', 'Appointment Reminder - Email', 'appointment_reminder', 'email', 'Appointment Reminder - {appointment_date} at {appointment_time}', 'Dear {patient_name},<br><br>This is a friendly reminder that you have an appointment scheduled with Dr. {doctor_name} on {appointment_date} at {appointment_time}.<br><br>Appointment Details:<br>- Date: {appointment_date}<br>- Time: {appointment_time}<br>- Doctor: Dr. {doctor_name}<br>- Reason: {appointment_reason}<br><br>If you need to reschedule or cancel, please contact us at {clinic_phone}.<br><br>Thank you,<br>{clinic_name}', '[\"patient_name\", \"doctor_name\", \"appointment_date\", \"appointment_time\", \"appointment_reason\", \"clinic_name\", \"clinic_phone\"]', 1, 1, '2025-10-13 23:36:52', '2025-10-13 23:36:52'),
...
(7, 'system_maintenance_email', 'System Maintenance Notice - Email', 'system_maintenance', 'email', 'System Maintenance Notification - {maintenance_date}', 'Dear Valued User,<br><br>We will be performing scheduled system maintenance that may affect our services.<br><br>Maintenance Details:<br>- Date: {maintenance_date}<br>- Time: {maintenance_time}<br>- Duration: {maintenance_duration}<br>- Affected Services: {affected_services}<br><br>During this time, you may experience temporary service interruptions. We apologize for any inconvenience this may cause.<br><br>If you have any urgent needs, please contact us at {emergency_contact}.<br><br>Thank you for your patience,<br>{clinic_name} IT Team', '[\"maintenance_date\", \"maintenance_time\", \"maintenance_duration\", \"affected_services\", \"emergency_contact\", \"clinic_name\"]', 1, 1, '2025-10-13 23:36:52', '2025-10-13 23:36:52');
...
(1, 'g854kk2hsmojuro2i1sfgr9ej0', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '2025-10-14 00:17:11', '2025-10-14 00:17:40', 1, '2025-10-14 01:17:40');
...
INSERT INTO `visit_queue` (`id`, `appointment_id`, `patient_id`, `status`, `queued_at`, `called_at`, `served_at`, `notes`, `created_at`) VALUES
(1, NULL, 7, 'queued', '2025-10-13 21:01:42', NULL, NULL, '', '2025-10-13 13:01:42'),
(2, NULL, 6, 'queued', '2025-10-14 08:03:00', NULL, NULL, '', '2025-10-14 00:03:00'),
(3, NULL, 5, 'queued', '2025-10-14 08:03:01', NULL, NULL, '', '2025-10-14 00:03:01'),
(4, NULL, 1, 'queued', '2025-10-14 08:24:18', NULL, NULL, 'Sakit ang edoy\n\n--- Vital Signs ---\nBP: 120/80\nTemp: 66°C\nPulse: 83 bpm\nResp Rate: 56\nWeight: 59 kg\nHeight: 73 cm\nO2 Sat: 91%\nPain Level: 7/10', '2025-10-14 00:24:18');
